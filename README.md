...
2. Upload the `user-cleanup-pro` folder to `/wp-content/plugins/`
3. Activate the plugin through the 'Plugins' menu in WordPress
4. Navigate to **Users > User Cleanup Pro** to configure settings
...
### Basic Setup
1. Navigate to **Users > User Cleanup Pro** in your WordPress admin
...
⚠️ **Important**: Always backup your database before running user cleanup operations!

1. Click **"Start Deletion Process"**
2. **Scanning Phase**: The plugin will scan all users to identify deletion candidates
3. **Deletion Phase**: Users will be deleted in batches with real-time progress updates
...
- ✅ Added support for millions of users
...
```
User Cleanup Pro WordPress Plugin
Copyright (C) 2025
...
- **GitHub Issues**: [Report bugs or request features](https://github.com/S4hk/user-cleanup-pro/issues)
